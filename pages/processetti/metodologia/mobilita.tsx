  ...
  return (
    <ProcessettiGraficiLayout head={props.head} links={metodologiaLinks}>
      <ion-grid fixed>
        ...
        <p>
          Per quanto concerne la mobilità extra urbana e il fenomeno migratorio
          verso la laguna, è stata registrata un’ampia casistica, che riflette
          la complessità di tali spostamenti.
        </p>
        <p>
        ...
        <p>
          Ciò non di meno gli <i>Account of journey or stay</i> rimangono
        ...
        <p>
          ...
          progetto non è unicamente interessata alla mobilità <i>extra</i>{' '}
          urbana ma anche a quella <i>intra</i> urbana o residenziale. La ferma
          volontà di tenerne traccia ha portato alla definizione di un modello
          che, attraverso la proprietà di localizzazione delle entità, risulta
          in grado di identificare e registrare la parrocchia (e alcune aree
          ...
          sia la mobilità ‘residenziale’ che quella lavorativa; là dove
          possibile con attenzione alla successione temporale.
        </p>
        <p>
          <ImageWrapper
            legend={
