    ...
    <ProcessettiGraficiLayout head={props.head} links={strumentiLinks}>
      ...
      <h1>Bibliografia</h1>
        <p className={mainStyles.indent1}>
          ...
          , tesi di laurea, dir. M. A. Visceglia, Sapienza-Università di Roma
        </p>
        <p className={mainStyles.indent1}>
          ...
          <i>L&apos;Italia delle contemporanea</i>, Roma, pp. 111-130
        </p>
        <p className={mainStyles.indent1}>
          Belfanti Carlo Marco (1990), &quot;Immigrazione e mestieri: i trentini
          a Mantova (secoli XVII e XVIII)&quot;,{" "}
          <i>Bollettino di demografia storica</i>, 12, pp. 102-115
        </p>
        <p className={mainStyles.indent1}>
        ...
        <p className={mainStyles.indent1}>
          ...
          <i>Le fonti della demografia storica in Italia</i>, I, parte II,
          Roma, pp. 647-699
        </p>
        <p className={mainStyles.indent1}>
        ...
        <p className={mainStyles.indent1}>
          ...
          del Vaticano, 1953, pp. 1271-1272
        </p>
        <p className={mainStyles.indent1}>
          ...
          <i>Revue de droit canonique</i>, <i>Études offerts à J. Gaudemet</i>, XXX,
          pp. 209-234
        </p>
        <p className={mainStyles.indent1}>
          Cristellon Cecilia (2011), &quot;Missionaria o in pericolo di
          apostasia? Donne cattoliche e matrimoni misti nei dibattiti del
          sant&apos;Ufficio&quot;, in G. Ciappelli, S. Luzzi e M. Rospocher (a
          cura di),{" "}
          <i>
        ...
        <p className={mainStyles.indent1}>
        Gaudemet Jean (1987),{" "}
        <i>Le mariage en Occident: les mœurs et le droit</i>, Parigi
        </p>
        <p className={mainStyles.indent1}>
          Jemolo A.C. (1993),{" "}
          <i>
        ...
        <p className={mainStyles.indent1}>
          Rasi Pietro (1953-54), &quot;Le formalità nella celebrazione del
        ...
        <p className={mainStyles.indent1}>
          ...
          corso&quot;, in G. Dall&apos;Olio, A. Malena e P. Scaramella (a cura
        ...
        <p className={mainStyles.indent1}>
          ...
          <i>Il Concilio di Trento e il moderno</i>, Bologna, pp. 437-483
        </p>
      </ion-grid>
