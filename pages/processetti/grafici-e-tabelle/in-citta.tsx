    ...
    <ProcessettiGraficiLayout head={props.head}>
      <ion-grid fixed>
        ...
        <p>
          ...
          proporzionalmente alla loro popolazione. Tre di esse si distinguono.
          In primo luogo, le parrocchie di San Geremia, posta sul versante nord
          ocidentale della città, e quella di San Pietro di Castello, ubicata
          sul versante più orientale. Queste sono le due parrocchie più
          densamente popolate della città, ma anche quelle con la più alta
          concentrazione di richiedenti, dovuta alla diversificazione sociale
          della loro popolazione. San Geremia era un'area a forte immigrazione
          dalla Terra Ferma, mentre San Pietro si connotava per la forte
          immigrazione dallo Stato da Mar; la prima era un'area periferica con
          una dinamica industria tessile, mentre la seconda ospitava una
          notevole attività portuale e marittima. Le professioni afferenti a
          questi due settori erano le più praticate fra i lavoratori immigrati e
          successivamente sposati a Venezia. L'altra parrocchia in cui vivono
          molti dei richiedenti era San Moisè, nel cuore della città, nel
          sestiere di San Marco. Rimane ad oggi difficile stabilire la logica di
        ...
        <p>
          ...
          la parrocchia di San Pietro di Castello è il luogo di residenza degli
          operai che hanno dichiarato di lavorare all'Arsenale. Rialto e le
          Mercerie, che costituiscono l'asse commerciale, nel cuore della città,
          attraggono negozianti e artigiani che vivono in altre zone a causa
          dell'elevato costo degli alloggi nel centro.
        </p>
        <p>
          Come i richiedenti, i testimoni vivono in tutta la città in
        ...
        <p>
          ...
          più elevato rispetto ai richiedenti si riflette sulla distribuzione
          urbana, assumendo questi un peso maggiore rispetto agli sposi nelle
          parrocchie centrali della città, di fatto più variegate dal punto di
          vista professionale e sociale. Inversamente la parrocchia di San
          Geremia, che registra un’ampia concentrazione di richiedenti, aveva
          proporzionalmente meno testimoni rispetto alle altre parrocchie.
        </p>
      </ion-grid>
