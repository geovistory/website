  ...
  return (
    <ProcessettiLayout head={props.head}>
      <ion-grid>
        <h1>Fonti</h1>
        <p>
          Archivio storico del Patriarcato di Venezia, <i>Curia patriarcale di
          Venezia, Sezione antica</i>
        </p>
        ...
        <p>
          Generalmente un <i>processetto</i> si compone di una formula introduttiva in
          latino, dove sono riportate le generalità della persona inquisita
          (nome, patronimico e cognome, origini, professione, e parrocchia di
          abitazione o lavoro), così come la ragione o le ragioni che resero
          necessaria la singola indagine prematrimoniale. A seguire, la data
          cronica e topica dell’audizione e la trascrizione delle testimonianze,
          precedute dalla presentazione dei singoli testimoni, per cui
          nuovamente sono fornite le medesime generalità. All’interno delle
          testimonianze, in volgare, possono emergere una serie di informazioni
          più complesse e articolate, che costituiscono le risposte al
          questionario stabilito dalle autorità ecclesiastiche veneziane:
          l’occasione di conoscenza tra richiedenti e testimoni (e tra testimone
          e il defunto, se l’inchiesta era atta a verificare la condizione
          vedovile), le conseguenti relazioni sociali, il tempo di permanenza in
          città e gli spostamenti dell’inquisito (o del defunto), avvenuti prima
          e dopo l’arrivo a Venezia, eventuali trasferimenti da una contrada
          all’altra, l’età del richiedente e l’eventuale consanguineità. Chiude
          la singola testimonianza la formula di rito, nuovamente in latino, con
          la conferma da parte del testimone della veridicità del dichiarato e
          la conformità di quanto riportato per iscritto, nonché l’indicazione
          della sua età.
        </p>
        <h3>Esemplificazione processetto</h3>
        <p>
