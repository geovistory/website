          ...
          <span className="ion-hide-sm-down">
            ...
            {props.sparqlLinkEnabled && (
              <>
                ...
                <ion-button
                  href={`https://sparklis-dev.geovistory.org/?title=Geovistory%20Project%20${props.title}&endpoint=https%3A//sparql.geovistory.org/api_v1_project_${props.projectId}&entity_lexicon_select=http%3A//www.w3.org/2000/01/rdf-schema%23label&concept_lexicons_select=http%3A//www.w3.org/2000/01/rdf-schema%23label`}
                  target="blank"
                >
                  Sparklis
                </ion-button>
